   ...
   return (
      <div className='flex flex-col items-center justify-between h-[73px] w-[430px] sm:w-full'>
         <div className='flex items-center justify-between w-full mb-24'>
            ...
            <div className='flex items-center justify-center mx:justify-between gap-4 w-full'>
         ...
         <div className='flex flex-col text-white items-center justify-center gap-5'>
            <div className='flex items-center justify-center gap-x-4'>
               ...
               <div className='text-sm opacity-60 font-semibold text-white'>Restaurants</div>
            </div>
            <div className='text-5xl font-Text2 font-bold text-white'>Restaurants</div>
         </div>
      </div>
   )
}

export default RestaurantsPageLinks